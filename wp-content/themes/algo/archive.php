						...
						?>
								...
								<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 blog_append">
									<div class="btn_bgstyle btn_arrow_style text-center">
										<!-- Button to increase the number of posts -->
										<!-- <form method="GET" action=""> -->
											<input type="hidden" name="num_posts" value="<?php echo $numberPosts + 4; ?>">
											<button class="btn_style loadmore_blog" type="submit">Load More Posts</button>
										<!-- </form>								 -->
									</div>
								</div>
						<?php
